...
{
    public class View_Page4_W : ViewComponent
    {
        private readonly YourlookContext _context;
        private readonly SP_Product _productRepository;
        public View_Page4_W(YourlookContext context, SP_Product productRepository)
        {
            _context = context;
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var page4lst = await _productRepository.Product_SA(classify);
